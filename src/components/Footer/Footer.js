        ...
        return (
            <Box sx={{ mt: 2, mb: 2 }}>
                <Typography color="white" align="center" variant="body2">
                    ...
                    01359 231772<br />
                    <Link color="inherit" href={'mailto:thurstonrugbyclub@live.co.uk'} underline="hover">
                ...
                <Typography color="white" align="center" variant="body2">
                    Website built by J. Gilroy<br />
                    <Link color="inherit" href={'mailto:VangisTechnology@gmail.com'} underline="hover">
                        VangisTechnology@gmail.com
                    </Link>
                </Typography>
            </Box>
        );
