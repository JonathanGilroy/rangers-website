...
function Home() {
    ...
    const contentToDisplay = () => {
        return (
            <>
            <Typography variant={mobileView ? 'h4' : 'h1'} align='center' sx={{mt: mobileView ? 2 : 2, mb: mobileView ? 2 : 4}}>
                        Thurston Rangers
                    </Typography>
                <Box sx={{
                    mr:
  ...
  alignItems="flex-start">
                    ...
                    <Card sx={{ mb: 2, mt: 2, width: mobileView ? 220 : 160, height: 125 }} style={{ backgroundColor: '#F0F0F0' }} elevation={4}>
                    <CardContent>
            ...
            />
                ...
                <Card sx={{ mb: 2, mt: 2, width: mobileView ? 220 : 350, height: mobileView ? 150 : 120 }} style={{ backgroundColor: '#F0F0F0' }} elevation={4}>
                    <CardContent>
                        <Typography variant={'h5'} align='center'>Rangers v Young Farmers</Typography>
                        <Typography align='center'>Robinson Field</Typography>
                        <Typography align='center'>KO: 5pm, 7th April 2023</Typography>
                    </CardContent>
                </Card>
                </Grid>
                </Grid>
                <Typography variant={mobileView ? 'h5' : 'h3'} align='center' sx={{mt:3, mb:3}}>
                        Blood, sweat and beers
                    </Typography>
                    <Typography align='justify' variant='body1' sx={{ mb: mobileView ? 2 : 4 }}>
                        ...
                        <img object-fit src={'cup-victory.jpg'}
                    alt="Thurston Rangers celebrating cup win."
                    style={{
                        width: mobileView ? '95%' : '75%',
                    }} />
                    </Box>
                        <Typography align='justify' variant='body1' sx={{ mb: mobileView ? 2 : 4, mt: mobileView ? 2 : 4 }}>
                        ...
                        including VP dinners, ladies luncheons, hog roasts and annual dinner.
                        </Typography>
                        <Box display='flex' justifyContent='center'>
                        <img object-fit src={'twos-cup-victory-2.jpg'}
